                  ...
                  >
                     ...
                     <div className="flex flex-wrap gap-2 text-sm text-default-600">
                        <RoomChip
                           ...
                           room={room}
                           icon={Bed}
                           label={`${room.noOfBedRoom} ${
                              room.noOfBedRoom > 1 ? "Bedrooms" : "Bedroom"
                           } `}
                        />
                        <RoomChip
                           mode="property"
                        ...
                        />
                        {[
                           RoomAvailability.RENTED,
                           RoomAvailability.Purchased,
                        ].includes(room.status as RoomAvailability) && (
                           <RoomChip
                              mode="property"
                              room={room}
                              icon={room.tenant ? User : UserX}
